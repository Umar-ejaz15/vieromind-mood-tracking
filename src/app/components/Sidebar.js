...
import { Home, List, Heart, Menu, X, Book } from "lucide-react";
...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { name: "Summary", path: "/summary", icon: Book },
  ...
  return (
    <>
      ...
      <div
        className={`
          fixed top-0 left-0 min-h-full w-full md:w-[30%] bg-white dark:bg-gray-900 shadow-lg flex flex-col
